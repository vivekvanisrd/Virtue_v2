...
export function TabList() {
  ...
  return (
    <div className="flex items-center gap-1.5 px-4 lg:px-8 bg-white/50 backdrop-blur-sm border-b border-slate-100 overflow-x-auto no-scrollbar h-12 whitespace-nowrap scroll-smooth">
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActive 
                  ? "bg-white border-slate-200 text-primary z-10" 
                  : "bg-slate-50 border-transparent text-slate-400 hover:bg-slate-100"
              )}
            >
              <div className="flex items-center gap-2 truncate pr-2">
                <tab.icon className={cn("w-3.5 h-3.5", isActive ? "text-primary" : "text-slate-400")} />
