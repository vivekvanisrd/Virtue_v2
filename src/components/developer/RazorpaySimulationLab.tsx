        ...
        payload: {
            payment: {
                entity: {
                    ...
                    email: "lab_tester@virtue.academy",
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center gap-3 justify-center text-slate-300">
          <p className="text-[10px] font-black uppercase tracking-widest">Simulation Key: VIRTUE_SIM_FIX_369</p>
          <div className="w-1 h-1 rounded-full bg-slate-200" />
          <p className="text-[10px] font-black uppercase tracking-widest">Protocol: Virtu3-Ledger-V2</p>
      </div>
    </div>
  );
}
