...
export default async function FeesPage() {
  ...
  return (
    <TabProvider>
      <div className="max-w-[1600px] mx-auto p-4 sm:p-8 space-y-10 min-h-screen bg-background text-foreground">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="space-y-2">
            ...
            <h1 className="text-5xl font-black text-foreground tracking-tighter leading-tight sm:text-6xl animate-in slide-in-from-left duration-700">
          ...
          <div className="flex flex-wrap items-center gap-4 animate-in fade-in zoom-in duration-1000">
            ...
            <Link href="/admin/fees/config" className="bg-slate-900 hover:bg-slate-800 text-white px-6 py-4 rounded-3xl flex items-center gap-3 transition-all active:scale-95 group shadow-lg shadow-slate-900/10">
              ...
              <div className="text-left">
                  <p className="text-[9px] font-black text-white/50 uppercase tracking-widest">Advanced Setup</p>
