    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="p-8 bg-slate-900 rounded-[3rem] text-white flex flex-col justify-between h-64 relative overflow-hidden shadow-2xl">
           ...
           <button 
             onClick={() => openTab({ id: "staff-roles", title: "Role Management", icon: ShieldCheck, component: "Staff" })}
             className="w-full py-4 bg-white/5 hover:bg-white/10 transition-all rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] border border-white/5 shadow-xl"
           >
              Configure RBAC
           </button>
        </div>
