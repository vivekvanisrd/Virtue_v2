    ...
    return (
      ...
      >
        ...
        <p className="text-foreground opacity-60 text-sm leading-relaxed mb-6 font-medium relative z-10">
          Your consent for the upcoming academic year ({consentData.academicYear?.year}) has been securely recorded. Thank you for continuing your journey with PaVa-EDUX Academy.
        </p>
