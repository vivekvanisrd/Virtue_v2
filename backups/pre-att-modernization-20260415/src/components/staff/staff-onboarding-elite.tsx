...
export function StaffOnboardingElite({ 
  ...
  const handleSubmit = async () => {
   ...
   return (
    <div className="max-w-4xl mx-auto h-full flex flex-col py-6 px-4 animate-in fade-in zoom-in duration-500 overflow-y-auto scrollbar-hide">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl font-black text-slate-900 tracking-tight">
          Personnel <span className="text-indigo-600">Enrolling.</span>
        </h1>
      ...
      <div className="w-full glass rounded-3xl premium-shadow border border-white/50 p-8 min-h-[450px] relative overflow-hidden">
