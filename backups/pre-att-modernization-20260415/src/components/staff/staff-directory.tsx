                    ...
                    <tr key={employee.id} className="hover:bg-slate-50/80 transition-all duration-300 group cursor-default">
                      <td className="px-6 py-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="text-sm font-black text-slate-900 tracking-tight leading-none mb-1.5 flex items-center gap-2">
                            ...
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                              ID: <span className="text-primary font-black font-mono leading-none bg-primary/5 px-1.5 py-0.5 rounded border border-primary/10 tracking-normal">{employee.staffCode}</span>
                            </p>
                          </div>
                        </div>
                      </td>
